  ...
  return (
    <div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-xl font-bold md:text-5xl mb-4 text-black dark:text-white max-w-4xl">
          Changelog from my journey
        </h2>
        <p
          className="text-neutral-700 dark:text-neutral-300 text-lg max-w-screen-md">
