...
import { placement } from "./placementData";

// Memoize by storing in a constant since this data doesn't change
    ...
    >
      <Card className="relative overflow-hidden bg-white hover:shadow-2xl transition-shadow duration-300">
        ...
        <CardContent className="relative z-10 p-10">
          <div className="flex flex-col sm:flex-row sm:gap-12 items-center space-y-4">
            {/* Photo with animation */}
            <motion.div
              whileHover={{ scale: 1.05 }}
              transition={{ type: "spring", stiffness: 300 }}
              className="relative ml-0 sm:ml-10 w-48 h-48"
            >
            ...
            <div className="text-center sm:text-left space-y-2">
              ...
              <p className="text-base font-normal text-slate-600 max-w-[80%] sm:max-w-none mx-auto">
                {program}
              </p>
