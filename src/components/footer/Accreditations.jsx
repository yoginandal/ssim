...
import naac from "@/assets/about/naac.png";
import nba from "@/assets/about/nba.png";
import III from "@/assets/about/III.png";
import aict from "@/assets/about/aicte.png";
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 sm:gap-5">
        ...
        <div className="md:col-span-8 lg:col-span-9 p-5 pt-3 sm:py-8 sm:pr-8 sm:!pl-2 flex flex-col justify-between">
          <div className="space-y-4">
            <p className="text-slate-700 text-sm md:text-lg leading-relaxed md:block hidden">{description}</p>
            <p className="text-slate-700 text-sm md:text-lg leading-relaxed md:hidden line-clamp-3">{description}</p>
