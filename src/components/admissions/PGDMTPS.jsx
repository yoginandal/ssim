...
const Overview = () => (
  <div className="space-y-3 p-3">
    <p className="text-lg text-gray-700 font-semibold">
      SSIM offers Post Graduate Diploma in Management with Triple Specialization (PGDM-TPS), a comprehensive two-year program that allows students to master three distinct areas of management.
    </p>
    <p className="text-lg text-gray-700">
      The PGDM-TPS program at Siva Sivani Institute of Management (SSIM) is designed to create versatile management professionals through a unique triple specialization format. Students choose one Major specialization, one Minor specialization, and one Sectorial specialization, providing them with a multi-dimensional understanding of business management.
    </p>
    <h3 className="font-bold text-mainBlue text-2xl">Program Structure</h3>
    <p className="text-gray-700 text-lg">
      The program offers a three-tier specialization approach:
    </p>
    <ul className="list-disc ml-4 list-inside text-gray-700 text-lg">
      <li>Major Specialization - Primary area of expertise</li>
      <li>Minor Specialization - Secondary management focus</li>
      <li>Sectorial Specialization - Industry-specific knowledge</li>
    </ul>
    ...
    <ul className="list-disc ml-4 list-inside text-gray-700 text-lg">
      <li>
        To develop versatile management professionals capable of handling complex business challenges
      </li>
      <li>To provide comprehensive exposure to multiple business domains</li>
      <li>To enhance both hard skills and soft skills essential for modern business leadership</li>
      <li>
        To create industry-ready professionals with multi-dimensional expertise
      </li>
    </ul>

    <h3 className="font-bold text-mainBlue text-2xl">Eligibility Criteria</h3>
    <p className="text-gray-700 text-lg">
      Candidates must meet the following requirements:
    </p>
    <ul className="list-disc ml-4 list-inside text-gray-700 text-lg">
      <li>Bachelor's degree in any discipline from a recognized university with minimum 50% marks</li>
      <li>Valid score in any of these entrance exams: CAT, XAT, CMAT, MAT, or ATMA</li>
      <li>Minimum 60% score in data interpretation and numerical ability sections</li>
    </ul>

    <div className="grid md:grid-cols-3 !mt-8 gap-6 h-full">
      {[
        {
          title: "Triple Advantage",
          description: "Master three distinct specializations for a competitive edge in the job market",
          icon: Award
        },
        {
          title: "Comprehensive Learning",
          description: "Blend of theoretical knowledge and practical industry exposure",
          icon: BookOpen
        },
        {
          title: "Career Growth",
          description: "Enhanced employability with multi-domain expertise",
          icon: TrendingUp
        }
      ].map((item, index) => (
        <motion.div
