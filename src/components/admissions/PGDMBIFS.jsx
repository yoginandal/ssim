...
const processData = [
  ...
  },
  {
    ...
    details:
      "Prepare and submit your Statement of Purpose (SOP) highlighting your interest in Banking, Insurance & Financial Services, along with a self-introduction video that showcases your personality and career goals.",
  },
  {
    step: 5,
    ...
    <div className="mt-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
      ...
      <ul className="space-y-2 text-gray-700">
        ...
        <li className="flex items-start gap-2">
          <Info className="w-5 h-5 text-red-600 mt-1 flex-shrink-0" />
          <span>
            Selection is based on overall profile, not just academic scores
          </span>
        </li>
      </ul>
    </div>
